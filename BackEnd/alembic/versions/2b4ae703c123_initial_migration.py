...
Revision ID: 2b4ae703c123
Revises: 
Create Date: 2026-05-12 19:25:29.048326
...
def downgrade() -> None:
    ...
    sa.Column('can_view_appointments', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('can_manage_appointments', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('can_book_walkins', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('can_register_patients', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('granted_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['doctor_id'], ['users.id'], name=op.f('doctor_staff_access_doctor_id_fkey'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['staff_user_id'], ['users.id'], name=op.f('doctor_staff_access_staff_user_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('doctor_staff_access_pkey')),
    sa.UniqueConstraint('doctor_id', 'staff_user_id', name=op.f('uq_doctor_staff'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    # ### end Alembic commands ###
