...
// src/pages/doctor/SetAvailability.tsx
import React, { useState } from "react";
import { motion } from "framer-motion";
import {
  Clock,
...
const SetAvailability: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* 🌫️ OVERLAY */}
      {/* Slightly stronger white overlay (90%) to make input fields readable */}
      ...
      <div className="relative z-10 p-6 h-full overflow-y-auto">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage your weekly schedule and available time slots for
              appointments
            </p>
          </div>
          ...
          {showSuccessMessage && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0 }}
              className="mb-6 p-4 bg-green-50/90 backdrop-blur-sm border border-green-200 rounded-lg flex items-center gap-3"
            >
              <CheckCircle className="w-5 h-5 text-green-600" />
              <p className="text-green-800 font-medium">
                Availability saved successfully!
          ...
          {/* Quick Actions */}
          <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Quick Actions
            </h2>
            <div className="flex flex-wrap gap-3">
          ...
          {/* Info Banner */}
          <div className="mb-6 p-4 bg-blue-50/80 backdrop-blur-sm border border-blue-200 rounded-lg flex items-start gap-3">
            <AlertCircle className="w-5 h-5 text-blue-600 mt-0.5" />
            <div>
              <p className="text-blue-800 font-medium mb-1">
                💡 UI Demo Mode
              ...
              <p className="text-sm text-blue-700">
                This is a UI-only demonstration. API integration can be added
                later. Changes are saved locally for this session.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {schedule.map((daySchedule, dayIndex) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: dayIndex * 0.05 }}
                className="bg-white/80 backdrop-blur-md rounded-xl shadow-sm border border-gray-100 p-6 hover:bg-white/90 transition-colors"
              >
                {/* Day Header */}
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
          ...
          <div className="mt-8 flex justify-end gap-4">
            <button
              onClick={() => window.history.back()}
              className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-white/80 transition-colors bg-white/50 backdrop-blur-sm"
            >
              Cancel
            </button>
            <button
          ...
          {/* Summary */}
          <div className="mt-8 bg-white/80 backdrop-blur-md rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">
              Availability Summary
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
