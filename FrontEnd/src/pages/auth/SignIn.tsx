// ============================================================================
// SignIn.tsx - Unified Authentication
...
import { GoogleLogin } from "@react-oauth/google"; // Remove CredentialResponse import
...
// Define Google credential response locally
...
const SignIn: React.FC = () => {
  ...
  const getRoleBasedRedirectPath = (userType: string | undefined): string => {
    switch (userType) {
      case "admin":
  ...
  // Handle Google Sign-In - Updated parameter type
