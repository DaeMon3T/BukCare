  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[95vh] overflow-y-auto shadow-2xl">
        {/* Modal Header with Patient-specific gradient */}
        <div className="sticky top-0 bg-gradient-to-r from-blue-600 via-cyan-500 to-cyan-500 border-b p-8 rounded-t-3xl text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold">Edit Patient Profile</h2>
              <p className="text-blue-100 mt-1">Update your medical information</p>
            </div>
            <button
              onClick={onClose}
              className="text-white/80 hover:text-white text-3xl hover:bg-white/20 w-10 h-10 rounded-full flex items-center justify-center transition"
            >
              ✕
            </button>
          </div>
        ...
        {/* Modal Footer */}
        <div className="sticky bottom-0 bg-gradient-to-r from-blue-600/10 via-cyan-500/10 to-cyan-500/10 border-t p-8 rounded-b-3xl">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-500">
              Your medical profile information is securely stored
            </div>
            <div className="flex gap-3">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-6 py-3 bg-gradient-to-r from-blue-600 via-cyan-500 to-cyan-500 text-white rounded-xl hover:from-blue-700 hover:via-cyan-600 hover:to-cyan-600 font-medium transition shadow-lg hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {saving ? (
        ...
        <div className="text-center space-y-6">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-16 h-16 border-4 border-cyan-200 border-t-cyan-500 rounded-full animate-spin" style={{ animationDirection: 'reverse' }}></div>
            </div>
          </div>
          <div>
            <p className="text-gray-700 font-medium">Loading your patient profile</p>
            <p className="text-gray-500 text-sm mt-2">Please wait while we fetch your medical information...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        {/* Top Banner with specified gradient */}
        <div className="bg-gradient-to-r from-blue-600 via-cyan-500 to-cyan-500 rounded-3xl p-8 mb-8 text-white shadow-xl">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100/90 mt-2">Manage your medical information and personal details</p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-bold">Patient ID: PT{formData.fname.charAt(0)}-{Date.now().toString().slice(-4)}</div>
              <div className="text-blue-100/80 text-sm mt-1">Medical records updated: Today</div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="px-6 pb-6 relative -top-12">
                ...
                <div className="text-center mt-8">
                  ...
                  <div className="inline-flex items-center gap-2 mt-3 px-4 py-1.5 bg-cyan-50 text-cyan-700 rounded-full text-sm">
                ...
                {selectedFile && (
                  <div className="mt-6">
                    <button
                      ...
                      className="w-full py-3 bg-gradient-to-r from-blue-600 via-cyan-500 to-cyan-500 text-white rounded-xl hover:from-blue-700 hover:via-cyan-600 hover:to-cyan-600 font-medium transition shadow-lg hover:shadow-xl disabled:opacity-60 flex items-center justify-center gap-2"
                    >
                      {uploadingPic ? (
                        <>
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-sm text-gray-500">Email for Medical Alerts</div>
                ...
                {formData.contact_number && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-cyan-600 mt-1">For appointment reminders</div>
                    </div>
                  </div>
                )}
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="text-xs text-gray-600 bg-gray-50 rounded-lg p-3">
                    Keep your contact information updated for important medical alerts and appointment reminders.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* Column 1 */}
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl p-5 hover:bg-blue-50 transition">
                    <div className="text-sm text-blue-600 mb-2">Full Name</div>
                    <div className="text-lg font-semibold text-gray-800">
                      {formData.fname} {formData.mname && `${formData.mname} `}{formData.lname}
                    </div>
                    <div className="text-xs text-gray-500 mt-2">Patient Name</div>
                  </div>
                  
                  <div className="bg-gradient-to-br from-cyan-50 to-cyan-100/50 rounded-2xl p-5 hover:bg-cyan-50 transition">
                    <div className="text-sm text-cyan-600 mb-2">Gender</div>
                    <div className="text-lg font-semibold text-gray-800">
                      {formData.sex === true ? 'Male' : formData.sex === false ? 'Female' : 'Not specified'}
                    </div>
                    <div className="text-xs text-gray-500 mt-2">Biological sex for medical records</div>
                  </div>
                  
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-5 hover:bg-blue-50/50 transition">
                    <div className="text-sm text-blue-600 mb-2">Date of Birth</div>
                    <div className="text-lg font-semibold text-gray-800">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl p-5 hover:bg-blue-50 transition">
                    <div className="text-sm text-blue-600 mb-2">Email Address</div>
                    ...
                    <div className="text-xs text-cyan-600 mt-2 flex items-center gap-1">
                      ...
                      Primary contact for medical updates
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-br from-cyan-50 to-cyan-100/50 rounded-2xl p-5 hover:bg-cyan-50 transition">
                    <div className="text-sm text-cyan-600 mb-2">Phone Number</div>
                    <div className="text-lg font-semibold text-gray-800">
                    ...
                    {formData.contact_number && (
                      <div className="text-xs text-gray-500 mt-2">For SMS appointment reminders</div>
                    )}
                  </div>
                  
                  <div className="bg-gradient-to-br from-blue-50/50 to-cyan-50/50 rounded-2xl p-5 hover:bg-blue-50/30 transition">
                    <div className="text-sm text-gray-600 mb-2">Profile Completion</div>
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-700">Medical Profile</span>
                        <span className="font-semibold text-blue-600">75%</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="bg-gradient-to-r from-blue-600 via-cyan-500 to-cyan-500 h-2 rounded-full w-3/4"></div>
                      </div>
                      <div className="text-xs text-gray-500 mt-2">
                        Complete your profile for better medical care
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-5">
                  ...
                  <div className="text-xs text-gray-500 mt-2">Local district</div>
                </div>
                
                <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl p-5">
                  <div className="text-sm text-cyan-600 mb-2">City</div>
                  <div className="text-lg font-semibold text-gray-800">
                    {formData.address?.city || 'Not specified'}
                  </div>
                  <div className="text-xs text-gray-500 mt-2">City/Municipality</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-5">
                  ...
                  <div className="text-xs text-gray-500 mt-2">Province/Region</div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50/80 to-cyan-50/80 rounded-2xl p-6 border border-blue-100">
                ...
                <div className="text-sm text-gray-500 mt-3">
                  This address is used for medical visits and emergency services
                </div>
              </div>
            </div>

            {/* Save Button Section */}
            <div className="bg-gradient-to-r from-blue-600/10 via-cyan-500/10 to-cyan-500/10 rounded-3xl border border-blue-200 p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-gray-800">Ready to update your medical profile?</h4>
                  <p className="text-gray-600 text-sm mt-1">Keep your information current for better healthcare</p>
                </div>
                <button
                  type="button"
                  onClick={handleSave}
                  disabled={saving}
                  className="px-8 py-4 bg-gradient-to-r from-blue-600 via-cyan-500 to-cyan-500 text-white rounded-xl hover:from-blue-700 hover:via-cyan-600 hover:to-cyan-600 font-semibold transition-all shadow-lg hover:shadow-xl hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {saving ? (
                    <>
                      <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
